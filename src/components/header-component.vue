  ...
  <div class="mb-7 flex items-center justify-between">
    ...
    <div class="flex items-center justify-center">
      ...
      <button
        ...
        :class="[
          themeStore.currentTheme === 'light' ? 'bg-zinc-600' : 'bg-orange-300',
      ...
      >
        <svg
          :class="[
            ...
            'fill-yellow-50',
            'duration-500',
            themeStore.currentTheme === 'dark' && 'dark:fill-zinc-900',
          ]"
          :viewBox="
            themeStore.currentTheme === 'dark' ? '-5.5 0 32 32' : '0 0 24 24'
          "
          xmlns="http://www.w3.org/2000/svg"
        >
          <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
